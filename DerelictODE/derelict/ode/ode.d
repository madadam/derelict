...
public:
    this()
    {
        ...
        {
            string winlib = "ode_double.dll";
            string linlib = "libode_double.so";
        }
        else
        {
            string winlib = "ode_single.dll";
            string linlib = "libode_single.so";
        }
        super(
            winlib ~ ", ode.dll",
...
protected:
    override void loadSymbols()
    {
        ...
        bindFunc(cast(void**)&dWorldStepFast1, "dWorldStepFast1");
        bindFunc(cast(void**)&dWorldSetAutoEnableDepthSF1, "dWorldSetAutoEnableDepthSF1");
        bindFunc(cast(void**)&dWorldGetAutoEnableDepthSF1, "dWorldGetAutoEnableDepthSF1");
